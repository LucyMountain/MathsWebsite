"""
Django settings for MathsWebsite project.
...
ROOT_URLCONF = 'MathsWebsite.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries': {
                'filters': 'sudoku.templatetags.filters',
            }
        },
    },
]

WSGI_APPLICATION = 'MathsWebsite.wsgi.application'
